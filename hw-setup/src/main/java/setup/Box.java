...
public class Box implements Iterable<Ball> {
    ...
    public Iterator<Ball> getBallsFromSmallest() {
        // Your code goes here.  Remove the exception after you're done.
        ArrayList<Ball> ascending = new ArrayList<Ball>();

        for (Ball currBall : this.ballContainer) {
            ascending.add(currBall);
        }

        ascending.sort(Comparator.comparing(Ball::getVolume));
